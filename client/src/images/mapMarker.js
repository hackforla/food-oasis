...
const MapMarker = (color, isVerified, splitInactive, onClick = null) => {
  ...
  if (!color) {
   ...
   c0.011-0.013,17.256-21.029,17.256-30.556C34.756,7.818,27.029,0.094,17.5,0.093z"
    ...
    const splitVerified = (
      ...
      >
        <g>
          <path
            fill="#FFFFFF"
            d="M9.392,13.763l-5.644,4.718L15.96,36.522l18.443-22.661c-0.609-2.965-1.99-5.643-3.907-7.84L16.608,24.218
		L9.392,13.763z"
          />
        </g>
        <path
	...
	c1.601,2.939,3.561,5.652,5.366,8.46l1.048-1.379V0.094l0,0C7.97,0.094,0.245,7.82,0.245,17.35c0,9.529,17.255,30.557,17.255,30.557
	v-0.001V33.407C15.97,34.208,14.149,33.277,13.404,32.055z"
        />
        <path
          fill={foodPantry}
          d="M34.055,12.507L18.779,32.158c-0.373,0.607-0.813,1.005-1.279,1.249v14.499
	c0.011-0.014,17.255-21.03,17.255-30.556C34.756,15.667,34.504,14.045,34.055,12.507z"
        />
        <path
          fill={foodPantry}
