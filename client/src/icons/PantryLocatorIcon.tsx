...
function PantryLocatorIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
...
const MemoPantryLocatorIcon = React.memo(PantryLocatorIcon);
export default MemoPantryLocatorIcon;
