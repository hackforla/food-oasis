...
const StakeholderEditModal = (props) => {
  const {
    classes,
    setToast,
    user,
  ...
  return (
    <Modal
      open={open}
      onClose={originalData !== emptyStakeholder && handleClose}
    ...
    >
      <Container component="main" maxWidth="md" className={classes.root}>
        ...
        <div className={classes.paper}>
          ...
          />
          <IconButton
            style={{ display: "block", marginLeft: "auto", padding: "0px" }}
            onClick={handleClose}
          >
...
StakeholderEditModal.propTypes = {
  ...
  stakeholderId: PropTypes.string,
};

export default withStyles(styles)(withRouter(StakeholderEditModal));
// export default StakeholderEditModal;
