        ...
        {list && (
          ...
          >
            ...
            <Grid container spacing={0}>
                <Grid xs={6}>
                  <div>
                    <a target="_blank" rel="noopener nofollow noreferrer" href="https://www.mapbox.com/" aria-label="Mapbox logo">
                      <svg width="88" height="23" viewBox="0 0 88 23" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fillRule="evenodd">
                        <defs>
                        ...
                        <g id="outline" opacity="0.3" stroke="#000" strokeWidth="3">
