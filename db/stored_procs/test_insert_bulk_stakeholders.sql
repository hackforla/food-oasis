...
CREATE OR REPLACE PROCEDURE test_insert_bulk_stakeholders(
  ...
  s_submitted_date TIMESTAMPTZ, s_submitted_login_id INT, s_approved_date TIMESTAMP, s_reviewed_login_id INT,
...
BEGIN
    ...
    FOREACH cat IN ARRAY categories
      LOOP
        INSERT INTO test_stakeholder_category
    ...
    FOREACH hours_element IN ARRAY hours_array
      LOOP
        INSERT INTO test_stakeholder_schedule(
