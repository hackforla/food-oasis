...
exports.up = (pgm) => {
  pgm.createTable(
    { schema: "public", name: "stakeholder_log" },
    {
      ...
      daycode: { type: "varchar(255)" },
      open: { type: "varchar(255)" },
      close: { type: "varchar(255)" },
      daycode1: { type: "varchar(255)" },
      day1_open: { type: "varchar(255)" },
      day1_close: { type: "varchar(255)" },
      daycode2: { type: "varchar(255)" },
      day2_open: { type: "varchar(255)" },
      day2_close: { type: "varchar(255)" },
      daycode3: { type: "varchar(255)" },
      day3_open: { type: "varchar(255)" },
      day3_close: { type: "varchar(255)" },
      daycode4: { type: "varchar(255)" },
      day4_open: { type: "varchar(255)" },
      day4_close: { type: "varchar(255)" },
      daycode5: { type: "varchar(255)" },
      day5_open: { type: "varchar(255)" },
      day5_close: { type: "varchar(255)" },
      daycode6: { type: "varchar(255)" },
      day6_open: { type: "varchar(255)" },
      day6_close: { type: "varchar(255)" },
      daycode7: { type: "varchar(255)" },
      day7_open: { type: "varchar(255)" },
      day7_close: { type: "varchar(255)" },
      year_round: { type: "text" },
      season_open: { type: "varchar(255)" },
      season_close: { type: "varchar(255)" },
      fm_id: { type: "numeric" },
