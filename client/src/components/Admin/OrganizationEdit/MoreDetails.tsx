...
interface FormikFieldTouched {
  [key: string]: boolean;
}

interface FormikFieldErrors {
  [key: string]: string;
}

interface MoreDetailsValues {
...
interface MoreDetailsProps {
  tabPage: number;
  values: MoreDetailsValues;
  touched: FormikFieldTouched;
  errors: FormikFieldErrors;
...
const MoreDetails: FC<MoreDetailsProps> = ({
  tabPage,
  values,
  touched,
  errors,
