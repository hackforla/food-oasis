...
function formatValue(value: any, field: string): ReactNode {
...
function isDifferent(valueA: any, valueB: any): boolean {
  return JSON.stringify(valueA) !== JSON.stringify(valueB);
}

const VersionComparison: FC<VersionComparisonProps> = ({
