      ...
      <>
        <dl>
          ...
          <dd>
            ...
            nearby options, sorted from nearest to farthest, will pop up on the
            left side of the page. Click “PANTRIES” or “MEALS” if you’d like to
            filter by type. Click “Details” on an entry to view information like
            Directions, Hours, Phone, Email, and Eligibility Requirements.
          </dd>
          ...
          <dd>
            No. The data Aloha Harvest uses to populate this directory includes
            all food pantry and meal programs we deliver food to that are open
            to the public. We deliver food to almost every program of this kind
            on the island, but not 100% of them. Furthermore, there are many
            places that individuals can apply to receive food assistance that
            are not open to the general public. A volunteer reviews our list
            once a week to confirm that all details are still current and
            correct.
          </dd>

          <dt>
            Where can I go for a comprehensive, statewide list of food resources
          ...
          <dd>
            ...
            registered social service agency in the state that helps get food to
            people who need it. They can also search a database of 4,000+
  ...
  },
  {
    ...
    content: (
      <>
        <dl>
          <dt>
            Interested in donating excess food, volunteering, or anything else?
          </dt>
          <dd>
          ...
          <dd>
            If someone is experiencing food insecurity, it means they are unable
            to consistently access or afford adequate food to live a healthy
            life.
          </dd>
          ...
          <dd>
            ...
            more than ever, we need to react to the changing needs of Hawaiʻi’s
            people, and providing a location-based, maintainable web app will
            decrease the friction in finding food resources.
          </dd>
