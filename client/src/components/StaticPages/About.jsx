...
const About = () => {
  ...
  return (
    <>
      <SEO
        title="About Us| Food Oasis"
        description="Food Oasis is a web-based directory that connects people to free food resources in Los Angeles."
        url="https://www.foodoasis.la/about"
      />
