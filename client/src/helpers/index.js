...
/**
 * This function takes in a openTimeFilter and a targetTimezone
 ...
 */
export function getNextDateForDay(openTimeFilter, targetTimezone) {
  const { day: dayInput, time: timeInput } = openTimeFilter;
