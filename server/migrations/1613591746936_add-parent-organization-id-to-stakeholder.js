...
exports.up = (pgm) => {
  pgm.sql(`
    ALTER TABLE public.parent_organization ALTER  id add generated always as identity;

    ALTER TABLE public.stakeholder_log ADD parent_organization_id int4 NULL;

    ALTER TABLE public.stakeholder_best ADD parent_organization_id int4 NULL;

    ALTER TABLE public.stakeholder_best ADD CONSTRAINT fk_stakeholder_best_parent_organization FOREIGN KEY (parent_organization_id) REFERENCES public.parent_organization(id) ON DELETE SET NULL;

    ALTER TABLE public.stakeholder_log ADD CONSTRAINT fk_stakeholder_log_parent_organization FOREIGN KEY (parent_organization_id) REFERENCES public.parent_organization(id) ON DELETE SET NULL;

    `);

  // Drop old version of create_stakeholder sproc
  pgm.sql(`
    DROP PROCEDURE IF EXISTS public.create_stakeholder(int4,int4,varchar,varchar,varchar,varchar,varchar,varchar,varchar,numeric,
        numeric,varchar,bool,varchar,varchar,varchar,int4,varchar,varchar,varchar,varchar,varchar,varchar,varchar,
        varchar,varchar,varchar,timestamptz,int4,timestamp,int4,timestamp,int4,timestamp,int4,varchar,varchar,
        varchar,varchar,varchar,varchar,varchar,varchar,bool,bool,bool,bool,varchar,varchar,varchar,varchar,varchar,
        varchar,varchar,varchar,bool,bool,bool,bool,bool,bool,bool,int4,bool,_int4,_stakeholder_hours,
        bool,bool,bool,bool,bool,bool);
`);

  pgm.sql(`
  CREATE OR REPLACE PROCEDURE public.create_stakeholder(INOUT s_id integer, s_tenant_id integer, s_name character varying, 
    s_address_1 character varying, s_address_2 character varying, s_city character varying, 
    s_state character varying, s_zip character varying, s_phone character varying, 
    s_latitude numeric, s_longitude numeric, s_website character varying, s_inactive boolean, 
    s_notes character varying, s_requirements character varying, s_admin_notes character varying, 
    s_created_login_id integer, s_parent_organization character varying, s_physical_access character varying, 
    s_email character varying, s_items character varying, s_services character varying, 
    s_facebook character varying, s_twitter character varying, s_pinterest character varying, 
    s_linkedin character varying, s_description character varying, s_submitted_date timestamp with time zone, 
    s_submitted_login_id integer, s_approved_date timestamp without time zone, s_reviewed_login_id integer, 
    s_assigned_date timestamp without time zone, s_assigned_login_id integer, s_claimed_date timestamp without time zone, 
    s_claimed_login_id integer, s_review_notes character varying, s_instagram character varying, 
    s_admin_contact_name character varying, s_admin_contact_phone character varying, 
    s_admin_contact_email character varying, s_donation_contact_name character varying, 
    s_donation_contact_phone character varying, s_donation_contact_email character varying, 
    s_donation_pickup boolean, s_donation_accept_frozen boolean, s_donation_accept_refrigerated boolean, 
    s_donation_accept_perishable boolean, s_donation_schedule character varying, 
    s_donation_delivery_instructions character varying, s_donation_notes character varying, 
    s_covid_notes character varying, s_category_notes character varying, s_eligibility_notes character varying, 
    s_food_types character varying, s_languages character varying, s_v_name boolean, s_v_categories boolean, 
    s_v_address boolean, s_v_phone boolean, s_v_email boolean, s_v_hours boolean, s_v_food_types boolean, 
    s_verification_status_id integer, s_inactive_temporary boolean, categories integer[], hours_array stakeholder_hours[], 
    s_food_bakery boolean, s_food_dry_goods boolean, s_food_produce boolean, 
    s_food_dairy boolean, s_food_prepared boolean, s_food_meat boolean,
...
`);
  ...
  pgm.sql(`
DROP PROCEDURE IF EXISTS public.update_stakeholder(varchar,varchar,varchar,varchar,varchar,varchar,varchar,
    numeric,numeric,varchar,bool,varchar,varchar,varchar,varchar,varchar,varchar,varchar,varchar,
    varchar,varchar,varchar,varchar,varchar,int4,timestamptz,int4,timestamp,int4,
    timestamp,int4,timestamp,int4,varchar,varchar,varchar,varchar,varchar,varchar,varchar,varchar,
    bool,bool,bool,bool,varchar,varchar,varchar,varchar,varchar,varchar,varchar,varchar,
    bool,bool,bool,bool,bool,bool,bool,int4,bool,
    int4,_int4,_stakeholder_hours,
    bool,bool,bool,bool,bool,bool);
...
CREATE OR REPLACE PROCEDURE public.update_stakeholder(
    s_name character varying, s_address_1 character varying, 
    s_address_2 character varying, s_city character varying, s_state character varying, 
    s_zip character varying, s_phone character varying, s_latitude numeric, s_longitude numeric, 
    s_website character varying, s_inactive boolean, s_notes character varying, s_requirements character varying, 
    s_admin_notes character varying, s_parent_organization character varying, 
    s_physical_access character varying, s_email character varying, s_items character varying, 
    s_services character varying, s_facebook character varying, s_twitter character varying, 
    s_pinterest character varying, s_linkedin character varying, s_description character varying, 
    s_modified_login_id integer, s_submitted_date timestamp with time zone, s_submitted_login_id integer, 
    s_approved_date timestamp without time zone, s_reviewed_login_id integer, s_assigned_date timestamp without time zone, 
    s_assigned_login_id integer, s_claimed_date timestamp without time zone, s_claimed_login_id integer, 
    s_review_notes character varying, s_instagram character varying, s_admin_contact_name character varying, 
    s_admin_contact_phone character varying, s_admin_contact_email character varying, 
    s_donation_contact_name character varying, s_donation_contact_phone character varying, 
    s_donation_contact_email character varying, 
    s_donation_pickup boolean, s_donation_accept_frozen boolean, s_donation_accept_refrigerated boolean, 
    s_donation_accept_perishable boolean, s_donation_schedule character varying, 
    s_donation_delivery_instructions character varying, s_donation_notes character varying, 
    s_covid_notes character varying, s_category_notes character varying, s_eligibility_notes character varying, 
    s_food_types character varying, s_languages character varying, 
    s_v_name boolean, s_v_categories boolean, s_v_address boolean, s_v_phone boolean, 
    s_v_email boolean, s_v_hours boolean, s_v_food_types boolean, s_verification_status_id integer, 
    s_inactive_temporary boolean, s_id integer, categories integer[], hours_array stakeholder_hours[], 
    s_food_bakery boolean, s_food_dry_goods boolean, s_food_produce boolean, s_food_dairy boolean, s_food_prepared boolean, 
    s_food_meat boolean, s_parent_organization_id integer
)
LANGUAGE plpgsql
AS $procedure$
DECLARE cat INT;
...
BEGIN
  ...
  IF FOUND THEN
    ...
    best_row.parent_organization_id,
      is_verified);
