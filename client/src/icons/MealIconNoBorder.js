...
import { mealProgram, white } from "theme/palette";

function MealIconNoBorder({
  height = "72px",
  width = "72px",
  selected = false,
  ...props
  ...
  return (
    ...
    >
      <path
        ...
        fill={selected ? white : mealProgram}
      />
      <path
...
const MemoMealIconNoBorder = React.memo(MealIconNoBorder);
export default MemoMealIconNoBorder;
